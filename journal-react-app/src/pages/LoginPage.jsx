    ...
    return (
        <div class="background">
            <div class="text-container">
                ...
                <div class="sub-heading">Capture your day in words and discover its soundtrack by connecting your Spotify account!</div>
                <div class="notice">Heads up! inJournally is currently awaiting extension approval from Spotify. If you'd like to use the
                    music tracking feature, it may take up to 36 hours for your account to be approved.</div>
